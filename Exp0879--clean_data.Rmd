...
exp_folders <- exp_info$`Exp title` %>%  # make full directories for these experiments
...
write_rds(x = dfs_list, "Exp0879--20200912_all_dfs_list_no_empties.rds") # write this list to an rds in this directory ## THIS IS TOO LARGE TO UPLOAD TO GITHUB!!!!
```

Isolate just the data relevant for plotting
```{r}
